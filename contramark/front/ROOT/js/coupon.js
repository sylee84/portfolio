    ...
    $.fn.coupon = function(options) {
        ...
        var calcGoodsDcAmt = function(obj,d){
            ...
            if(obj != null) {
                ...
                var li_dcAmt    = $(obj).parents("li").parents("ul").children().eq(5); //할인금액 li
        ...
        var calcTotalDcAmt = function(){
            ...
            $(".tCoupon_List").each(function(){
                goodsDcAmt = $(this).children().eq(5).data().dc_amt;
            ...
            $("#totalCouponAmt").data("totalCouponAmt",goodsTotalDcAmt+orderTotalDcAmt);
        }
        ...
        var createPop = (function(){
            ...
            var _order_qtt = 0;
                $.ajax({
                    type : "POST",
                    url : "/front/coupon/selectAvailableOrderCouponList.do",
                    ...
                    success : function(data){
                        ...
                        $.each(settings.params, function (i){
                            ...
                            $.each(data.resultList, function (j){
                                if(data.resultList[j].couponKindCd != '02') { //모바일 쿠폰 제외
                        ...
                        /*주문쿠폰*/
                        couponOrderList  =  "";
                        couponOrderList +=  "   <ul class='tCoupon_List02'>";
                        ...
                        documentCouponPopup.find(".btn_my_coupon").click(function(){
                            location.href='/front/coupon/couponList.do';
                        });
                        ...
                        documentCouponPopup.find(".selectGoodsCoupon").on("change", function(){
                            ...
                            var salePrice   = $(this).parents("li").parents("ul").children().eq(2).data().salePrice;   //선택한 상품 판매 가격
                            var qtt         = $(this).parents("li").parents("ul").children().eq(1).data().goodsQtt;    //선택한 상품 수량
                            ...
                            $(this).each(function(){
                                ...
                                if(d.couponBnfCd == '02') {
                                    if((salePrice*qtt) <= d.couponBnfValue) {
                                        Storm.LayerUtil.alert("상품 금액보다 쿠폰 할인 금액("+commaNumber(d.couponBnfValue)+"원)이 많은 경우<br>사용이 불가능합니다.");
                                        $(this).val("");
                                ...
                                if((salePrice*qtt) < d.couponUseLimitAmt) {
                                    Storm.LayerUtil.alert("해당 쿠폰의 최소 사용 가능금액은 "+commaNumber(d.couponUseLimitAmt)+"원 이상입니다.");
                                    $(this).val("");
                                    Storm.SelectUtil.reset(this);   //셀렉트박스 초기화(label)
                                    return false;
                                }
                        ...
                        documentCouponPopup.find(".btn_popup_ok").on("click", function(){
                            ...
                            try{result.dcTotalAmt = $("#totalCouponAmt").data().totalCouponAmt;
                            }catch (e) {result.dcTotalAmt="0";}
